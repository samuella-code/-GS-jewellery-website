    ...
    images: [
        {
            id: 1,
            name: "Angled view",
            src: "https://tailwindui.starxg.com/plus-assets/img/ecommerce-images/product-page-03-product-01.jpg",
...
const relatedProducts = [
    {
        ...
        href: "#",
        imageSrc:
            "https://tailwindui.starxg.com/plus-assets/img/ecommerce-images/product-page-03-related-product-01.jpg",
        imageAlt:
                                ...
                                <div>
                                    ...
                                    >
                                        <div className="flex items-center space-x-3">
                                            <button onClick={() => setCount(count - 1)} className="px-2 py-1 bg-gray-200 hover:bg-gray-300 rounded-md">
                                                -
                                            </button>
                                            <input
                                                type="number"
                                                value={count}
                                                className="w-10 p-1 outline-none text-center border border-gray-300 rounded-md"
                                            />
                                            <button onClick={() => setCount(count + 1)} className="px-2 py-1 bg-gray-200 hover:bg-gray-300 rounded-md">
                                                +
                                            </button>
