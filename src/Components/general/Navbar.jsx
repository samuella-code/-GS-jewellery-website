                ...
                <nav aria-label="Top" className="mx-auto w-full px-4 sm:px-6 lg:px-8">
                    <div className="border-b border-gray-200">
                        <div className="flex h-16 items-center">
                            ...
                            <input type="text" className="w-96 mx-5 max-md:hidden border-2 text-sm rounded border-gray-300 px-4 py-2" placeholder="Search..." />
                            ...
                            <div className="ml-auto flex items-center">
                                ...
                                <div className="ml-4 flow-root lg:ml-6">
                                    <Link to="#" className="p-2 text-gray-400 hover:text-gray-500 flex">
